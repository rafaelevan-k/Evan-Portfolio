    ...
    <div className="relative overflow-x-hidden selection:bg-ink selection:text-on-dark">
      ...
      <section id="about" className="relative min-h-screen flex items-center pt-20 overflow-hidden">
        <div className="max-w-6xl mx-auto px-6 py-12 w-full relative z-10">
          <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between gap-16 lg:gap-8">
            ...
            >
              ...
              <div className="flex gap-8 sm:gap-12 mt-16 pt-8 border-t border-hairline w-full justify-center lg:justify-start">
                {[
                  ...
                  <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 + i * 0.1, duration: 0.5 }} key={stat.label} className="flex flex-col">
            ...
            <motion.div style={{ y, opacity }} className="relative flex-shrink-0 lg:ml-auto w-full max-w-md lg:w-[480px] aspect-square">
              ...
              >
                <Image src="/foto-profil.webp" alt="Rafael Evan Kristanto" fill className="object-cover scale-105" priority />
              </motion.div>
      ...
      <section id="projects" className="py-32 relative z-20 bg-canvas">
        <div className="max-w-6xl mx-auto px-6">
          <SectionHeader title="Featured Projects" subtitle="Portfolio" description="A curated selection of software I've built, demonstrating full-stack capabilities, modern frontend architecture, and user-centric design." />
      ...
      <section id="certifications" className="py-32 relative z-20 bg-surface-soft/30 border-y border-hairline">
        <div className="max-w-6xl mx-auto px-6">
          <SectionHeader title="Professional Certifications" subtitle="Achievements" description="Continuous learning and skill validation through recognized industry standards in Web Development." />
      ...
      <section id="archive" className="py-32 relative z-20 bg-canvas text-ink border-b border-hairline overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10 flex flex-col items-center">
          ...
          <p className="text-lg md:text-xl text-ink/60 mb-10 max-w-2xl text-balance">
            Explore a 3D interactive documentation space containing my complete Curriculum Vitae, detailed certifications, volunteer and organization activities, and awards.
          </p>
          <MagneticButton as="button" onClick={handleEnterArchive} variant="primary">
            Enter The Archive
            <ArrowRight className="w-4 h-4" />
          </MagneticButton>
        </div>
      ...
      <section id="contact" className="py-32 relative z-20 bg-canvas">
        <div className="max-w-5xl mx-auto px-6">
          <SectionHeader title="Let's build something together" subtitle="Contact" description="Currently open for new opportunities. Whether you have a question or just want to say hi, I'll try my best to get back to you!" />
      ...
      <footer className="border-t border-hairline py-10 bg-surface-soft/50 backdrop-blur-sm relative z-20">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-full bg-ink flex items-center justify-center text-on-dark font-display font-bold text-[10px]">R</div>
            <span className="font-display font-semibold text-sm text-ink tracking-tight">Rafael Evan Kristanto</span>
          </div>
          <p className="text-muted-text text-sm font-medium">&copy; {new Date().getFullYear()} All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
